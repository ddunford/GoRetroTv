...
The real 1.1B→1.12B run produced 20,000,000 examined instructions; 8,830,170 hits in the selected PC range; 2,207,388 watched reads; 200,264 watched writes; 2,208,124 call samples; and 1,130 o-code reads. The four-record cap was respected for every detailed log. Its local capture is `.artifacts/instruments-real-1120m.log`.
